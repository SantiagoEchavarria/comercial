...
public class ComercialService implements ComercialServiceIface{
    ...
    public ComercialService(ProductoDAOIface productoDAO, CategoriaDAOIface categoriaDAO, 
	ClienteDAOIface clienteDAO, FacturaDAOIface facturaDAO, DocumentoDAOIface documentoDAO) {
	...
	public Factura buscarFacturaPorIdConClienteDetalleProducto(Long nroFactura) {
		return facturaDAO.buscarPorIdConClienteDetalleProducto(nroFactura);
	}
