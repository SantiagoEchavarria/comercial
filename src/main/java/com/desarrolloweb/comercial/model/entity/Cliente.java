...
public class Cliente implements Serializable {
    ...
    public Cliente(Long id, String tipoIdentificacion, Long identificacion, String nombreCompleto, String direccion,
            String telefono, String correoElectronico, LocalDate fechaIngreso, Integer capacidadCredito) {
        this.id = id;
    ...
    public String toString() {
        return "{id: " + id + ", identificacion: " + identificacion + ", nombre completo: " + nombreCompleto + ", capacidad crédito: "
                + capacidadCredito + " ...}";
    }
}